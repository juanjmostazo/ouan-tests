...
#ifndef __GrassFrameListener_H__
#define __GrassFrameListener_H__
...
class GrassFrameListener: public ExampleFrameListener
{
protected:
...
public:
    ...
    GrassFrameListener(RenderWindow* win, Camera* cam, bool useBufferedInputKeys = false, bool useBufferedInputMouse = false)
    {
        mDebugOverlay = OverlayManager::getSingleton().getByName("Core/DebugOverlay");
		overlay = OverlayManager::getSingleton().create("InfoOverlay");
	...
	virtual void setBallPos(const Vector3 pos)
	{
		ballPos = pos;
	}
    ...
    void showDebugOverlay(bool show)
    {
		...
		//else overlay = OverlayManager::getSingleton().create("InfoOverlay");
    }
